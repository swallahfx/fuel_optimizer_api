...
#     class Meta:
#         model = FuelStation
#         fields = ['opis_id', 'name', 'address', 'city', 'state', 'retail_price', 
#                  'latitude', 'longitude']


# class RouteRequestSerializer(serializers.Serializer):
#     start_location = serializers.CharField(max_length=255, help_text="Starting location (e.g., 'New York, NY')")
#     end_location = serializers.CharField(max_length=255, help_text="Destination location (e.g., 'Los Angeles, CA')")
...
#     gallons = serializers.FloatField(required=False)
#     cost_at_station = serializers.FloatField(required=False)


# class RouteResponseSerializer(serializers.Serializer):
#     start_coordinates = serializers.ListField(child=serializers.FloatField())
#     end_coordinates = serializers.ListField(child=serializers.FloatField())
#     total_distance_miles = serializers.FloatField()
#     estimated_drive_time = serializers.CharField()
#     fuel_stops = FuelStopSerializer(many=True)
#     fuel_cost_summary = serializers.DictField()
